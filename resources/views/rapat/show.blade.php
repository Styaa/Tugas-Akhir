    ...
    <div class="container py-5">
        ...
        <div class="list-group mt-3">
            @foreach ($rapat->peserta as $peserta)
                <div class="list-group-item d-flex align-items-center">
                    <img src="{{ asset('storage/profile/' . $peserta->user->foto) }}" class="rounded-circle me-3"
                        width="50" height="50" alt="Foto Peserta">
                    <div>
        ...
        <div class="text-center mb-4 mt-4">
            ...
            @if (!$izin)
                ...
                <a type="button" class="btn btn-primary w-sm-100" data-bs-toggle="modal" data-bs-target="#izinrapat">Saya
                    tidak bisa hadir</a>
            @else
