                    ...
                    <div class="col-md-12">
                        <div class="card border-0 mb-4 no-bg">
                            <div class="card-header py-3 px-0 d-sm-flex align-items-center  justify-content-between border-bottom">
                                <h3 class=" fw-bold flex-fill mb-0 mt-sm-0">Anggota </h3>
                            ...
                            <div class="card teacher-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div class="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                                        ...
                                        <span class="light-info-bg py-1 px-2 rounded-1 d-inline-block fw-bold small-11 mb-0 mt-1">{{ $anggota->strukturOrmawas[0]->divisiOrmawas->keterangan }} ({{ $anggota->strukturOrmawas[0]->jabatan->nama }})</span>
