                                                    ...
                                                    <tbody>
                                                        @php
                                                            ...
                                                            foreach ($anggotaEvaluasi as $anggota) {
                                                                ...
                                                                if ($nilai >= 0.8) {
                                                                    $categories['Sangat Baik (0.8-1.0)']++;
                                                                } elseif ($nilai >= 0.6) {
                                                                    $categories['Baik (0.6-0.79)']++;
                                                                } elseif ($nilai >= 0.4) {
                                                                    $categories['Cukup (0.4-0.59)']++;
                                                                } elseif ($nilai >= 0.2) {
                                                                    $categories['Kurang (0.2-0.39)']++;
                                                                } else {
                                                                    $categories['Sangat Kurang (0-0.19)']++;
                                                                }
                                                            }
                                                        ...
                                                        @foreach ($categories as $category => $count)
                                                            <tr>
                                                                <td>{{ $category }}</td>
                                                                <td>{{ $count }}</td>
                                                                <td>{{ $total > 0 ? number_format(($count / $total) * 100, 1) : 0 }}%
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                        ...
                                        <table class="table table-hover align-middle mb-0">
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <th class="py-3" width="10%" class="text-center">Kehadiran (20%)
                                                    </th>
                                                    <th class="py-3" width="10%" class="text-center">Kontribusi (25%)
                                                    </th>
                                                    <th class="py-3" width="10%" class="text-center">Tanggung Jawab
                                                        (20%)</th>
                                                    <th class="py-3" width="10%" class="text-center">Kualitas (20%)
                                                    </th>
                                                    <th class="py-3" width="10%" class="text-center">Penilaian Atasan
                                                        (15%)</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="d-flex flex-column">
                                                                ...
                                                                <span
                                                                    class="badge {{ getNormalizedBadgeClass($anggota->kehadiran_normalized) }}">
                                                        ...
                                                        <td class="text-center">
                                                            <div class="d-flex flex-column">
                                                                ...
                                                                <span
                                                                    class="badge {{ getNormalizedBadgeClass($anggota->kontribusi_normalized) }}">
                                                        ...
                                                        <td class="text-center">
                                                            <div class="d-flex flex-column">
                                                                ...
                                                                <span
                                                                    class="badge {{ getNormalizedBadgeClass($anggota->tanggung_jawab_normalized) }}">
                                                        ...
                                                        <td class="text-center">
                                                            <div class="d-flex flex-column">
                                                                ...
                                                                <span
                                                                    class="badge {{ getNormalizedBadgeClass($anggota->kualitas_normalized) }}">
                                                        ...
                                                        <td class="text-center">
                                                            <span
                                                                class="badge {{ getAtasanBadgeClass($anggota->penilaian_atasan) }} p-2">
                                                                {{ number_format($anggota->penilaian_atasan, 2) }}
                                                            </span>
                                                        </td>
                                                        <td class="text-center">
                                                            <span
                                                                class="badge {{ getNormalizedBadgeClass($anggota->nilai_akhir) }} p-2 fs-6">
