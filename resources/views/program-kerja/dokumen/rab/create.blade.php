            ...
            <table class="table table-bordered">
                ...
                <tbody id="pemasukan-body">
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="form-control biaya" name="pemasukan[biaya][]" placeholder="Biaya">
                        </td>
                        ...
                        <td><input type="number" class="form-control total" name="pemasukan[total][]" placeholder="Total"
                                readonly></td>
                        ...
                        <tbody id="pengeluaran-body-{{ $item->id }}">
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control"
                                        name="pengeluaran[{{ $item->id }}][komponen][]" placeholder="Komponen Biaya">
                                </td>
                                <td><input type="number" class="form-control biaya"
                                        name="pengeluaran[{{ $item->id }}][biaya][]" placeholder="Biaya"></td>
                                <td><input type="number" class="form-control jumlah"
                                        name="pengeluaran[{{ $item->id }}][jumlah][]" placeholder="Jumlah"></td>
                                <td><input type="text" class="form-control satuan"
                                        name="pengeluaran[{{ $item->id }}][satuan][]" placeholder="Satuan"></td>
                                <td><input type="number" class="form-control total"
                                        name="pengeluaran[{{ $item->id }}][total][]" placeholder="Total" readonly></td>
                                <td><button type="button" class="btn btn-danger remove-row">Hapus</button></td>
                            </tr>
                        </tbody>
                    </table>
