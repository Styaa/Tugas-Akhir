                                                ...
                                                <div class="d-flex align-items-center justify-content-between mt-5">
                                                    ...
                                                    <div class="btn-group" role="group"
                                                        ...
                                                        <button type="button" class="btn btn-outline-secondary edit-button"
                                                            ...
                                                            data-bs-target="#editproject{{ $program->id }}"
                                                            data-id="{{ $program->id }}" data-kode="{{ $kode_ormawa }}"><i
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-list avatar-list-stacked pt-2">
                                                    ...
                                                    <img class="avatar rounded-circle sm"
                                                        src="{{ url('/') . '/images/xs/avatar3.jpg' }}" alt="">
                                                    <img class="avatar rounded-circle sm"
                                                        src="{{ url('/') . '/images/xs/avatar9.jpg' }}" alt="">
                                                    <img class="avatar rounded-circle sm"
                                                        src="{{ url('/') . '/images/xs/avatar7.jpg' }}" alt="">
                                                    <img class="avatar rounded-circle sm"
                                                        src="{{ url('/') . '/images/xs/avatar10.jpg' }}" alt="">
                                                    <img class="avatar rounded-circle sm"
                                                        src="{{ url('/') . '/images/xs/avatar11.jpg' }}" alt="">
                                                    <img class="avatar rounded-circle sm"
